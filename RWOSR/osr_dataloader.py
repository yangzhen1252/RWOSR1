...
class MNIST_OSR(object):
    def __init__(self, known, train_dir, test_dir, out_dir, use_gpu=True, num_workers=2, batch_size=20, img_size=224):
        ...
        testset = CustomDataset(test_dir, transform=transform)
        outset = CustomDataset(out_dir, transform=transform)
