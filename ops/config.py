...
parser.add_argument('--log_base',
                    default='./resultslocal', type=str, metavar='PATH',
                    help='path to save logs (default: none)')

# for number of fourier spaces
parser.add_argument ('--num_f', type=int, default=48, help = 'number of fourier spaces')
...
parser.add_argument ('--lambdap', type = float, default = 20.0, help = 'weight decay for weight1 ')
...
parser.add_argument ('--classes_num', type=int, default=10, help = 'number of epoch for lambda to decay')
